...
#define normCO2 850       // и выше - желтый
...
#define normHum 8      // и ниже - желтый
...
void setLED() {
  ...
  else if ((dispCO2 >= maxCO2) && LEDType == 0 || (dispHum <= minHum) && LEDType == 1 || (dispTemp >= maxTemp) && LEDType == 2 || (dispRain <= minRain) && LEDType == 3 || (dispPres <= minPress) && LEDType == 4) setLEDcolor(3);                // красный
